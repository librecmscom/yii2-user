...
return [
    ...
    'Phone verification code input error.' => '短信验证码错误。',
    ...
    'This mobile address has already been taken' => '该手机号码已被使用。',
    'This slug has already been taken' => '该标识已被使用',
    'Time zone' => '时区',
